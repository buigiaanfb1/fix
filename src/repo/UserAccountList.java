...
//	String encodePassword = enc.encodeToString(rePassword.getBytes());
	...
	public void createNewAccount() {
		...
		while (true) {
			...
			rePassword = PasswordField.readPassword("Enter password again: ");
...
//		    System.out.println("The password entered is: "+password);
	...
	public void changePassword() {
		if (successfullyLoggedIn == true) {
			...
			int pos = findId(accountId);
			oldPassword = PasswordField.readPassword("Enter old password: ");
			newPassword = PasswordField.readPassword("Enter new password: ");
			renewPassword = PasswordField.readPassword("Enter new password again: ");
